...
const question = {
    ...
    choices: [
        ...
        { text: "It depends on various factors - I usually have to move by scooter / car on daily basis, but for longer travels I usually prefer taking a good old trains, especially when travelling alone.", outcome: { fra: 10 } },
