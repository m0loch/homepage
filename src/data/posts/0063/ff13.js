    ...
    return (
        <>
            ...
            {splitText(`
                ...
                Produced by Yoshinori Kitase, directed by Motomu Toriyama (at his first mainline job after Final Fantasy X-2 and Final Fantasy XII: Revenant Wings), and featuring a development team of over 200 people (and rounding up to a ~70 million USD budget), the game was plagued by numerous issues: coordinating such a large workforce was a challenge on its own, and transitioning from PS2 to PS3 basically meant starting over from scratch both in terms of engine (the internally developed Crystal Tools - we will bounce back to this later) and assets.
