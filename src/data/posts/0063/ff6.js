...
function FF6() {
    return (
        ...
        {splitText(`
            ...
            <i>I just want to add that while her reprinted version is already very strong (it is banned in Duel Commander, as of writing), her "base form" is a top tier cEDH commander.</i>
