...
function FF1() {
    return (
        ...
        `)}
        <p>Three NPCs are also featured in the set with <a href="https://gatherer.wizards.com/FIN/en-us/15/azusa-lost-but-seeking" target="_blank" rel="noreferrer">Princess Sarah</a> being the princess of Cornelia that gets abducted in the beginning by <a href="https://gatherer.wizards.com/FIN/en-us/221/garland-knight-of-cornelia" target="_blank" rel="noreferrer">Garland, Knight of Cornelia</a><InlineSpoiler mask="*">The flavour text being the infamous line "I, Garland, will knock you all down" is the icing of the cake</InlineSpoiler>, and <a href="https://gatherer.wizards.com/FIN/en-us/62/matoya-archon-elder" target="_blank" rel="noreferrer">Matoya, Archon Elder</a> being a blind witch that the party will meet just after the end of the prologue.</p>
        {splitText(`
